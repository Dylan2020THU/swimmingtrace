...
export const PLAN_LIMITS: Record<Plan, PlanLimits> = {
  FREE: { maxPools: 1, maxMembers: 25, features: { export: false, challenges: false, apiKeys: false } },
  PRO: { maxPools: 20, maxMembers: 1000, features: { export: true, challenges: true, apiKeys: true } },
};
